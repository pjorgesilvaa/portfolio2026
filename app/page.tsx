...
export default function Home() {
  return (
    <>
      <header className="py-12 px-6 flex flex-col gap-2">
      ...
      <footer className="px-6 mt-16">
        <TypographyP className="text-xs">
          Heavly inspired in great web designers, coded in Visual Studio Code and loudly implemented by yours truly. Built with Next.js and
          Tailwind CSS, deployed with Vercel. Keep on building stuff!
        </TypographyP>
      </footer>
    </>
  )

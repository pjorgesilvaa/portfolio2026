...
export default function BlogListingClient({
  ...
  // Keep local search in sync when URL changes externally (back/forward)
  ...
  function navigate(overrides: Partial<{ search: string; category: string; sort: string; page: number }>) {
    ...
    const pageVal  = overrides.page     !== undefined ? overrides.page     : 1; // reset to 1 on filter change
    ...
    <div className="w-full md:max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <select
          ...
          className="px-4 py-2.5 rounded-lg bg-white border border-gray-200 text-[#2B3437] outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 cursor-pointer"
        >
      ...
      {totalPages >= 1 && (
        <div className="flex items-center justify-center gap-2 mt-16">
          <button
            ...
            className="px-4 py-2 rounded-lg border border-gray-200 text-sm font-semibold text-[#3F555D] hover:border-primary hover:text-primary disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200"
          >
            ← Prev
          </button>

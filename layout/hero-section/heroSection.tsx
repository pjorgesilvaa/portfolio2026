...
export default async function HeroSection() {
  ...
  return (
    <>
      <div className="w-full md:w-7xl m-auto flex flex-col lg:flex-row gap-8 lg:gap-0 justify-between items-center lg:px-8">
        <div className="w-full lg:max-w-xl flex flex-col items-start">
          <h2 className="text-primary font-semibold uppercase hero-animate" style={{ animationDelay: '0ms' }}>
            {t.hero.role}
          </h2>
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold flex flex-col">
          ...
          <div className="w-full lg:w-max flex items-center justify-between lg:gap-2 mt-4 hero-animate" style={{ animationDelay: '540ms' }}>
            <Link
              href="#projects"
        ...
        <div className="hero-fade-in w-full aspect-3/4 lg:w-112.5 lg:h-150 lg:aspect-auto" style={{ animationDelay: '200ms' }}>

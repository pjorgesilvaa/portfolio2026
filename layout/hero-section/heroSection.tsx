    ...
    <>
      <div className="w-full md:w-7xl m-auto flex flex-col md:flex-row gap-4 md:gap-0 justify-between items-center md:px-8">
        <div className="w-full max-w-xl flex flex-col items-start">
          ...
          <h1 className="text-[#2B3437] text-4xl md:text-7xl font-bold">Crafting digital</h1>
          <h1 className="text-primary text-4xl md:text-7xl font-bold break-all">masterpieces</h1>
          <h1 className="text-[#2B3437] text-4xl md:text-7xl font-bold">through intent.</h1>
